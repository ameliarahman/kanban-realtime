...
<div class="panel-group">
  <div class="panel panel-default">
    <div class="panel-heading" id="heading-title">Todo</div>
      ...
      <div class="panel-group">
        <div class="panel panel-default">
          ...
          <div class="panel-body text-left">
            ...
            <div>
              <a @click="showDetail(task)" href="#" data-toggle="modal" data-target="#detailTodo" class="btn btn-primary" role="button">Show Detail</a>
            </div>
              ...
              <div class="modal-dialog text-left">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body ">
                    ...
                    <a type="submit" data-toggle="modal" data-target="#delete-task-todo" class="btn btn-danger" role="button">Delete</a>
                    <div id="delete-task-todo" class="modal fade" role="dialog">
                      ...
                      <button type="submit" class="btn btn-warning" data-dismiss="modal" @click="move('backlog')">BackLog</button>
                       <button type="submit" class="btn btn-info" data-dismiss="modal" @click="move('doing')">Doing</button>
                    </form>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    deleteTask () {
      db.ref(`/todo/${this.taskDetail.key}`).remove()
    },
    move (direction) {
      const newTask = {
      ...
      if (direction === 'backlog') {
        db.ref(`/backlog`).push(newTask)
      } else if (direction === 'doing') {

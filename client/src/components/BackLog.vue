<template>
  <div class="panel-group">
    <div class="panel panel-default">
      <div class="panel-heading" id="heading-title">Back Log</div>
        ...
        <div class="panel-group">
          <div class="panel panel-default">
            ...
            <div class="panel-body text-left">
              ...
              <div>
                <a @click="showDetail(task)" href="#" data-toggle="modal" data-target="#detailBackLog" class="btn btn-primary" role="button">Show Detail</a>
              </div>
                ...
                <div class="modal-dialog text-left">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body ">
                      ...
                      <a type="submit" data-toggle="modal" data-target="#delete-task" class="btn btn-danger" role="button">Delete</a>
                      <div id="delete-task" class="modal fade" role="dialog">
                        ...
                        <button type="submit" class="btn btn-warning" data-dismiss="modal" @click="moveToTodo">Todo</button>
                      </form>
                    </div>
                  </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      deleteTask () {
        db.ref(`/backlog/${this.taskDetail.key}`).remove()
      },
      moveToTodo () {
        const newTask = {
